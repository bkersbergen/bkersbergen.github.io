...
In my [dissertation](https://dare.uva.nl/search?identifier=01b24940-4388-4cc8-af66-735c5c55bcdf), _Expanding Boundaries in Scalable Session-Based Recommendations_, I demonstrate that nearest-neighbor methods can rival or even outperform deep learning models on large-scale datasets, especially under production constraints. I developed scalable algorithms for low-latency inference, robust benchmarking under resource limits, and efficient data debugging using Shapley values for data attribution.
